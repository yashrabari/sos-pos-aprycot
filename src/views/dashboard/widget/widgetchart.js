                     ...
                     <div className="text-center">
                        ...
                        <div>
                           <span className="text-success">
                              <svg xmlns="http://www.w3.org/2000/svg"  width="10" height="10" className="mx-1"  viewBox="0 0 20 20" fill="currentColor">
                                 <path fillRule="evenodd" d="M5.293 7.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L11 5.414V17a1 1 0 11-2 0V5.414L6.707 7.707a1 1 0 01-1.414 0z" clipRule="evenodd" />
                              </svg>
                              10%
                           </span>
                           <span className="mx-1">Increased</span>
                        </div>
                     </div>
                  </Card.Body>
               ...
               <Card>
                  <Card.Body>
                     ...
                     <div className="text-center">
                        ...
                        <div>
                           <span>
                              <svg xmlns="http://www.w3.org/2000/svg" className="mx-1" width="10" height="10"  viewBox="0 0 20 20" fill="currentColor">
                                 <path fillRule="evenodd" d="M5.293 7.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L11 5.414V17a1 1 0 11-2 0V5.414L6.707 7.707a1 1 0 01-1.414 0z" clipRule="evenodd" />
                              </svg>
                              20%
                           </span>
                     ...
                     <div className="text-center">
                        ...
                        <div>
                           <span className="text-danger">
                              <svg xmlns="http://www.w3.org/2000/svg" className="mx-1" width="10px" height="10px"  viewBox="0 0 20 20" fill="currentColor">
