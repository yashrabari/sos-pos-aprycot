                            ...
                            <Card.Body>
                                <Form id="form-wizard1" className="text-center mt-3">
                                    ...
                                    <fieldset className={`${show === 'A' ? 'd-block' : 'd-none'}`}>
                                        ...
                                        <button type="button" name="next" className="btn btn-primary rounded next action-button float-end" value="Next" onClick={() => AccountShow('Account')} >Next</button>
                                    </fieldset>
                                    <fieldset className={`${show === 'Account' ? 'd-block' : 'd-none'}`}>
                                        ...
                                        <button type="button" name="next" className="btn btn-primary rounded next action-button float-end" value="Next" onClick={() => AccountShow('Personal')} >Next</button>
                                        <button type="button" name="previous" className="btn btn-dark rounded previous action-button-previous float-end me-3" value="Previous" onClick={() => AccountShow('A')} >Previous</button>
                                    </fieldset>
                                    <fieldset className={`${show === 'Personal' ? 'd-block' : 'd-none'}`}>
                                        ...
                                        <button type="button" name="next" className="btn btn-primary rounded next action-button float-end" value="Submit" onClick={() => AccountShow('Image')} >Submit</button>
                                        <button type="button" name="previous" className="btn btn-dark rounded previous action-button-previous float-end me-3" value="Previous" onClick={() => AccountShow('Account')} >Previous</button>
                                    </fieldset>
