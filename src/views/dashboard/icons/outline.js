                    ...
                    <Card className="mb-4">
                        ...
                        <Card.Body>
                            <div className="icon-grid">
                                ...
                                <div className="icon-box">
                                    <div className="overlay">
                                        <Button variant="btn btn-sm btn-soft-primary" data-copy-target="#svg-container-19" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </div>
                                ...
                                <div className="icon-box">
                                    <div className="overlay">
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </div>
                                ...
                                <div className="icon-box">
                                    <div className="overlay">
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-62" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </div>
                                    ...
                                    <div id="svg-container-104">
                                            <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <mask maskUnits="userSpaceOnUse" x="3" y="0" width="18" height="24" fill="black">
                                                    ...
                                                    <path d="M4 3.00004C4 1.89547 4.89543 1.00004 6 1.00004H13.0801C13.664 1.00004 14.2187 1.25517 14.5986 1.69845L19.5185 7.43826C19.8292 7.80075 20 8.26243 20 8.73985V21C20 22.1046 19.1046 23 18 23H6C4.89543 23 4 22.1046 4 21V3.00004Z"></path>
                                                </mask>
                                                <path d="M4 3.00004C4 1.89547 4.89543 1.00004 6 1.00004H13.0801C13.664 1.00004 14.2187 1.25517 14.5986 1.69845L19.5185 7.43826C19.8292 7.80075 20 8.26243 20 8.73985V21C20 22.1046 19.1046 23 18 23H6C4.89543 23 4 22.1046 4 21V3.00004Z" stroke="#130F26" strokeWidth="2" mask="url(#path-1-outside-1)"></path>
                                                <mask maskUnits="userSpaceOnUse" x="3" y="0" width="18" height="24">
                                                <mask maskUnits="userSpaceOnUse" x="3" y="0" width="18" height="24" fill="black">
                                                    <rect fill="white" x="3" width="18" height="24"></rect>
                                                    <path d="M4 3.00004C4 1.89547 4.89543 1.00004 6 1.00004H13.0801C13.664 1.00004 14.2187 1.25517 14.5986 1.69845L19.5185 7.43826C19.8292 7.80075 20 8.26243 20 8.73985V21C20 22.1046 19.1046 23 18 23H6C4.89543 23 4 22.1046 4 21V3.00004Z"></path>
                                                </mask>
                                                <path d="M4 3.00004C4 1.89547 4.89543 1.00004 6 1.00004H13.0801C13.664 1.00004 14.2187 1.25517 14.5986 1.69845L19.5185 7.43826C19.8292 7.80075 20 8.26243 20 8.73985V21C20 22.1046 19.1046 23 18 23H6C4.89543 23 4 22.1046 4 21V3.00004Z" fill="#130F26"></path>
                                                <path d="M4 3.00004C4 1.89547 4.89543 1.00004 6 1.00004H13.0801C13.664 1.00004 14.2187 1.25517 14.5986 1.69845L19.5185 7.43826C19.8292 7.80075 20 8.26243 20 8.73985V21C20 22.1046 19.1046 23 18 23H6C4.89543 23 4 22.1046 4 21V3.00004Z" stroke="#130F26" strokeWidth="2" mask="url(#path-2-outside-2)"></path>
                                                </mask>
                                                <path d="M14 6V0L21 8H16C14.8954 8 14 7.10457 14 6Z" stroke="#130F26"></path>
                                                <mask fill="white">
                                                ...
                                                <path fillRule="evenodd" clipRule="evenodd" d="M7 14.5945L8.99429 12.1334C9.12172 11.9761 9.34898 11.9549 9.50189 12.0859C9.6548 12.217 9.67546 12.4507 9.54804 12.6079L7.93828 14.5945L9.54804 16.581C9.67546 16.7383 9.6548 16.972 9.50189 17.103C9.34898 17.2341 9.12172 17.2128 8.99429 17.0556L7 14.5945Z" stroke="#130F26" strokeWidth="2" strokeLinecap="round" mask="url(#path-4-inside-3)"></path>
                                                <path fillRule="evenodd" clipRule="evenodd" d="M13.771 11.1638C13.9576 11.2542 14.0356 11.4769 13.9451 11.6611L10.9973 17.6664C10.9069 17.8506 10.6823 17.9267 10.4957 17.8363C10.3091 17.7458 10.2311 17.5232 10.3215 17.3389L13.2693 11.3336C13.3598 11.1494 13.5844 11.0733 13.771 11.1638Z" fill="#130F26"></path>
                                                <mask fill="white">
                                                ...
                                                <path fillRule="evenodd" clipRule="evenodd" d="M17 14.5945L15.0057 17.0556C14.8783 17.2128 14.651 17.2341 14.4981 17.1031C14.3452 16.972 14.3245 16.7383 14.452 16.581L16.0617 14.5945L14.452 12.6079C14.3245 12.4507 14.3452 12.217 14.4981 12.0859C14.651 11.9549 14.8783 11.9761 15.0057 12.1334L17 14.5945Z" stroke="#130F26" strokeWidth="2" strokeLinecap="round" mask="url(#path-6-inside-4)"></path>
                                        </svg>
                                    </div>
                                </div>
                            </div>
