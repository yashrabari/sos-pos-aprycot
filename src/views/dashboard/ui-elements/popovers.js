...
import {Container,Row,Col,Button,Card,OverlayTrigger,Popover,Tooltip} from 'react-bootstrap'
                    ...
                    <Col sm="12" lg="6">
                        ...
                        <Card>
                            ...
                            <p>Four options are available: top, right, bottom, and left aligned.</p>
                                ...
                                <Button  variant="soft-primary mt-2">Popover on top</Button>
                                </OverlayTrigger>{' '}
                                <OverlayTrigger trigger="click" placement="right" overlay={
                                        <Popover id="popover-basic">
                                            <Popover.Body>Vivamus sagittis lacus vel augue laoreet rutrum faucibus.</Popover.Body>
                                    ...
                                    <Button variant="soft-secondary mt-2">Popover on end</Button>
                                </OverlayTrigger>{' '}
                                <OverlayTrigger trigger="click" placement="bottom" overlay={
                                        <Popover id="popover-basic">
                                            <Popover.Body>Vivamus sagittis lacus vel augue laoreet rutrum faucibus.</Popover.Body>
                                    ...
                                    <Button variant="soft-danger mt-2">Popover on Bottom</Button>
                                </OverlayTrigger>{' '}
                                <OverlayTrigger trigger="click" placement="left" overlay={
                                        <Popover id="popover-basic">
                                            <Popover.Body>Vivamus sagittis lacus vel augue laoreet rutrum faucibus.</Popover.Body>
                                    ...
                                    <Button variant="soft-info mt-2">Popover on Start</Button>
                                </OverlayTrigger>{' '}
                            </Card.Body>
                        </Card>
                    </Col>
